...
export type SignVariant =
  ...
  | {
      kind: "roundabout-ads";
      exits: {
        angle: "left" | "ahead-left" | "ahead" | "ahead-right" | "right";
        label: string;
        route?: string;
      }[];
...
function Sym({ k, color = "#000", size = 60 }: { k: SymbolKey; color?: string; size?: number }) {
  ...
  switch (k) {
    ...
    case "uneven":
      return box(<path d="M6 74 L26 42 L44 60 L60 36 L82 66 L92 66 L92 78 L6 78 Z" />);
    case "steep-down":
      return (
    ...
    case "quayside":
      return (
        <svg width={s} height={s} viewBox="0 0 100 100">
          ...
          <path
            d="M4 78 Q18 72 32 78 T60 78 T88 78 T100 78"
            fill="none"
            stroke={color}
            strokeWidth="4"
            strokeLinecap="round"
          />
          <path
            d="M4 90 Q18 84 32 90 T60 90 T88 90 T100 90"
            fill="none"
            stroke={color}
            strokeWidth="4"
            strokeLinecap="round"
    ...
    case "keep-left":
      return box(
        <path d="M62 10 Q34 44 20 88 L34 92 L38 78 L48 82 L38 60 L28 60 Q40 34 68 20 Z" />,
      );
    case "keep-right":
      return box(
        <path d="M38 10 Q66 44 80 88 L66 92 L62 78 L52 82 L62 60 L72 60 Q60 34 32 20 Z" />,
      );
  ...
  switch (variant.kind) {
    case "warning": {
      ...
      return (
        <div className="relative inline-flex flex-col items-center">
          ...
          {variant.label && (
            <div className="mt-1 text-[10px] font-bold tracking-widest text-foreground">
              {variant.label}
            </div>
          )}
        </div>
        ...
        >
          ...
          {variant.label && !variant.symbol && (
            <div
              ...
              style={{ fontSize: px * 0.16, fontFamily: "Arial, sans-serif" }}
            >
              {variant.label}
            </div>
          )}
    ...
    case "info-green":
      return (
        ...
        >
          <div className="text-center font-bold" style={{ fontSize: px * 0.15 }}>
            {variant.label}
          </div>
        </div>
      );
          ...
          >
            ...
            >
              <svg
                ...
                width="70%"
                height="80%"
                fill={!isGreen ? "#050505" : "transparent"}
              >
                {/* DfT standing figure */}
    ...
    case "route-lanes": {
      ...
      const arrowFor = (a: "up" | "up-left" | "up-right") => {
        if (a === "up") return "M50,6 L64,26 L56,26 L56,52 L44,52 L44,26 L36,26 Z";
        if (a === "up-left") return "M14,32 L36,18 L36,26 L60,26 L60,44 L36,44 L36,52 Z";
