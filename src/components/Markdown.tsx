...
const components: Components = {
  h1: ({ node: _n, ...p }) => (
    <h1 className="mt-8 mb-4 font-display text-3xl text-foreground" {...p} />
  ),
  h2: ({ node: _n, ...p }) => (
    <h2 className="mt-8 mb-3 font-display text-2xl text-foreground" {...p} />
  ),
  h3: ({ node: _n, ...p }) => (
    <h3 className="mt-6 mb-2 font-display text-xl text-foreground" {...p} />
  ),
  ...
  ul: ({ node: _n, ...p }) => (
    <ul className="my-4 list-disc space-y-1 pl-6 text-foreground/90" {...p} />
  ),
  ol: ({ node: _n, ...p }) => (
    <ol className="my-4 list-decimal space-y-1 pl-6 text-foreground/90" {...p} />
  ),
  blockquote: ({ node: _n, ...p }) => (
    <blockquote
      className="my-4 border-l-4 border-primary bg-secondary/40 px-4 py-2 italic"
      {...p}
    />
  ),
  ...
  pre: ({ node: _n, ...p }) => (
    <pre
      className="my-4 overflow-x-auto rounded border border-border bg-secondary p-3 text-sm"
      {...p}
    />
  ),
  img: ({ node: _n, ...p }) => (
