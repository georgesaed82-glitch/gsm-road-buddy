      ...
      >
        <div
          ...
          style={{
            ...
            transition:
              dragging.current || pinchStart.current || touchPinch.current
                ? "none"
    ...
    >
      <defs>
        ...
        <pattern id="grass-tex" width="10" height="10" patternUnits="userSpaceOnUse">
          ...
          <path
            d="M2 8 L2.6 4 M5 9 L4.6 5 M7.5 8 L7.9 4"
            stroke="rgba(0,0,0,0.18)"
            strokeWidth="0.5"
          />
          <path
            d="M2 7.5 L2.6 3.5 M5 8.5 L4.6 4.5 M7.5 7.5 L7.9 3.5"
      ...
      {(() => {
        ...
        for (let x = 380; x <= 600; x += 24) {
          cones.push(
            <g key={`cone-${x}`}>
              <polygon
                points={`${x - 3},${238} ${x + 3},${238} ${x + 4.5},${248} ${x - 4.5},${248}`}
                fill="#ff7a1a"
              />
      ...
      <g fill={PAINT} opacity="0.35">
        ...
        <polygon
          points="560,278 548,278 548,268 532,288 548,308 548,298 560,298"
      ...
      <g fontFamily="Arial, sans-serif" fontSize="9" fontWeight="700" fill={PAINT}>
        <text x="14" y="16" letterSpacing="0.4">
          LEFT VERGE
        </text>
        <text x="14" y="200" letterSpacing="0.4">
          CENTRAL RESERVATION
        </text>
        <text x="14" y="352" letterSpacing="0.4">
          VERGE
        </text>
      </g>
    </svg>
...
function RoadStuds() {
  ...
  return (
    ...
    >
      <ZoomPan
        aspect="3/4"
        label="UK dual carriageway from above showing road stud colours — pinch or scroll to zoom in"
      >
        <DualCarriagewayStudsSvg ref={svgRef} />
      </ZoomPan>
      <p className="sr-only">
        Text description of the road studs diagram: a top-down view of a UK dual carriageway with
        the hard shoulder on the left and traffic flowing up the page. From left to right the layout
        is: grass verge, hard shoulder, left-hand lane (lane 1), right-hand lane (lane 2), central
        reservation, opposite carriageway, and grass verge. Red reflective studs mark the left edge
        line between the hard shoulder and the left-hand lane (lane 1). White studs mark the broken
        centre line between the two lanes. Amber studs mark the right edge line next to the central
        reservation. Green studs mark the main carriageway edge where a slip road joins from the
        bottom-left. Green and yellow studs mark temporary road layouts such as contraflows and
        roadworks. Use the zoom in, zoom out and reset buttons to enlarge the diagram.
      </p>
      ...
      <ul className="mt-4 grid gap-2 text-sm sm:grid-cols-2">
        <li className="flex items-start gap-2">
          ...
          <span>
            <strong>Red</strong> — between the edge of the carriageway and the hard shoulder.
          </span>
        </li>
        <li className="flex items-start gap-2">
          <span className="mt-1 h-3 w-3 shrink-0 rounded-full bg-white ring-1 ring-white/40" />
          <span>
            <strong>White</strong> — between lanes, and along the centre of the road.
          </span>
        </li>
        <li className="flex items-start gap-2">
          <span className="mt-1 h-3 w-3 shrink-0 rounded-full bg-[#f59e0b] ring-1 ring-white/40" />
          <span>
            <strong>Amber</strong> — right edge of the carriageway next to the central reservation
        ...
        <li className="flex items-start gap-2">
          ...
          <span>
            <strong>Green</strong> — edge of the main carriageway at lay-bys and slip roads.
          </span>
        </li>
        <li className="flex items-start gap-2 sm:col-span-2">
          <span className="mt-1 h-3 w-3 shrink-0 rounded-full bg-[#facc15] ring-1 ring-white/40" />
          <span>
            <strong>Green / yellow</strong> — a temporary road layout, for example at contraflows
            and roadworks.
          </span>
        </li>
      </ul>
...
function SignCard({ children, title, desc }: { children: ReactNode; title: string; desc: string }) {
  return (
  ...
  return (
    ...
    >
            ...
            <dl className="mt-3 grid grid-cols-4 gap-2 text-center">
              {[
                ...
                <div key={c.k} className="border border-border/60 py-2">
                  <dt className="text-[9px] font-semibold uppercase tracking-wider text-accent">
                    {c.k}
                  </dt>
        ...
        <table className="w-full border-collapse text-sm">
          <thead>
            <tr className="border-b border-border text-left">
              <th className="py-2 pr-3 text-[11px] font-semibold uppercase tracking-wider text-accent">
                Vehicle type
              </th>
              <th className="py-2 px-2 text-center text-[11px] font-semibold uppercase tracking-wider text-accent">
                Built-up
                <br />
                (mph)
              </th>
              ...
              <th className="py-2 pl-2 text-center text-[11px] font-semibold uppercase tracking-wider text-accent">
                Motorway
              </th>
            </tr>
          </thead>
      ...
      <p className="mt-4 text-xs text-muted-foreground">
        A <strong>built-up area</strong> is any road with a system of street lighting (lamps not
        more than 200 yards apart) unless a sign says otherwise — the default is 30 mph. In Scotland
        the goods-vehicle limits on single and dual carriageways are 40 mph and 50 mph respectively.
      </p>
      ...
      <div className="mt-6">
        ...
        <div className="mt-3 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">
          <SignCard
            title="20 mph limit"
            desc="Mandatory limit — often around schools, hospitals and residential streets."
          >
            <SpeedSignCircle mph={20} />
          </SignCard>
          <SignCard
            title="30 mph limit"
            desc="Default in built-up areas with street lighting, unless a sign says different."
          >
            <SpeedSignCircle mph={30} />
          </SignCard>
          <SignCard
            title="40 mph limit"
            desc="Common on urban dual carriageways and busy A-roads out of town."
          >
            <SpeedSignCircle mph={40} />
          </SignCard>
          <SignCard
            title="50 mph limit"
            desc="Rural single carriageways with hazards, or roadworks on faster roads."
          >
            <SpeedSignCircle mph={50} />
          </SignCard>
          <SignCard
            title="60 mph limit"
            desc="A specific 60 mph limit sign — do not confuse with the national limit disc."
          >
            <SpeedSignCircle mph={60} />
          </SignCard>
          <SignCard
            title="70 mph limit"
            desc="Shown on the approach to motorways and some dual carriageways."
          >
            <SpeedSignCircle mph={70} />
          </SignCard>
          <SignCard
            title="National speed limit applies"
            desc="White disc with a diagonal black bar. Actual mph depends on your vehicle and road type — check the table above."
          >
            <SpeedSignCircle variant="national" />
          </SignCard>
          <SignCard
            title="20 mph zone"
            desc="A whole area at 20 mph — the limit stays until you see an 'End of zone' sign, even without repeaters."
          >
            <SpeedSignCircle variant="zone20" mph={20} />
          </SignCard>
          <SignCard
            title="Minimum speed"
            desc="Blue disc — you must not drive slower than the number shown (e.g. in some tunnels)."
          >
            <SpeedSignCircle variant="minimum" mph={30} />
          </SignCard>
          <SignCard
            title="End of minimum speed"
            desc="Blue disc with a red diagonal — the minimum speed requirement no longer applies."
          >
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-2">
        <div className="border border-border p-4">
          ...
          <ul className="mt-2 list-disc space-y-1.5 pl-5 text-sm">
            <li>
              <strong>Street lights + no signs = 30 mph</strong> (20 mph in parts of Wales).
            </li>
            <li>
              <strong>No street lights = national speed limit</strong> for your vehicle and road.
            </li>
            <li>
              <strong>Small repeater signs</strong> on lamp posts confirm the current limit.
            </li>
            <li>
              A limit applies <strong>from the sign onwards</strong> until a new limit sign changes
              it.
            </li>
          </ul>
        </div>
        <div className="border border-border p-4">
          ...
          <ul className="mt-2 list-disc space-y-1.5 pl-5 text-sm">
            <li>
              Limits are a <strong>maximum</strong>, not a target — drive to the conditions.
            </li>
            <li>
              <strong>Towing?</strong> Drop 10 mph on single/dual carriageways and motorways.
            </li>
            <li>
              <strong>Large goods vehicles</strong> stay at 60 mph on the motorway.
            </li>
            <li>
              Newly-qualified drivers must obey <strong>every</strong> limit — penalty points in the
              first 2 years revoke your licence at 6 points.
            </li>
          </ul>
        </div>
      </div>
...
const DualCarriagewayStudsSvg = forwardRef<SVGSVGElement>((_props, ref) => {
  ...
  return (
    ...
    >
      ...
      <desc id={descId}>
        A bird's-eye view of a UK dual carriageway with the hard shoulder on the left and traffic
        flowing up the page. Red studs mark the left edge line between the hard shoulder and the
        left-hand lane (lane 1). White studs mark the broken centre line between the two lanes.
        Amber studs mark the right edge line next to the central reservation. Green studs mark the
        main carriageway edge where a slip road joins from the bottom-left. Green and yellow studs
        are used for temporary layouts such as contraflows and roadworks.
      </desc>
      <defs>
      ...
      <g fill="#ffffff" opacity="0.55">
        <polygon
          points={`${(xHard + xMid) / 2},30 ${(xHard + xMid) / 2 - 8},46 ${(xHard + xMid) / 2 + 8},46`}
        />
        <rect x={(xHard + xMid) / 2 - 2.5} y="46" width="5" height="20" />
        <polygon
          points={`${(xMid + xLane2R) / 2},30 ${(xMid + xLane2R) / 2 - 8},46 ${(xMid + xLane2R) / 2 + 8},46`}
        />
    ...
    >
      ...
      <div className="mt-4 flex flex-wrap gap-4 text-xs text-muted-foreground">
        <span className="flex items-center gap-2">
          <span className="h-3 w-3 rounded-sm" style={{ backgroundColor: "#0ea5e9" }} /> Thinking
          distance
        </span>
        <span className="flex items-center gap-2">
          <span className="h-3 w-3 rounded-sm" style={{ backgroundColor: "#dc2626" }} /> Braking
          distance
        </span>
      </div>
      <p className="mt-4 text-xs text-muted-foreground">
        Rule of thumb: leave at least a <strong>two-second gap</strong> to the vehicle in front on a
        dry road, <strong>four seconds</strong> in the wet.
      </p>
    </Panel>
  );
}
...
function CrossingIcon({ kind }: { kind: "pelican" | "puffin" | "toucan" }) {
  ...
  return (
    <div
      className="flex items-center gap-1 rounded-sm px-1.5 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-white"
    ...
    >
      ...
      <div>
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          <div className="flex items-center gap-4">
            ...
            <p className="text-sm text-muted-foreground">
              <strong>Red and amber also means STOP.</strong> Do <strong>not</strong> go until the{" "}
              <strong>green</strong> shows. Stay behind the white line, keep the brake on and be
              ready to move off smoothly when green appears.
            </p>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="max-w-prose text-sm text-muted-foreground">
              <p>
                <strong>
                  Solid amber means <span className="text-red-600">STOP</span>.
                </strong>{" "}
                Do <strong>not</strong> go past the amber light unless one of these applies:
              </p>
              <ul className="mt-2 list-disc pl-5">
                <li>
                  You have <strong>already crossed the white line</strong> when the amber shows.
                </li>
                <li>
                  <strong>Stopping might cause an accident</strong> — e.g. the vehicle behind is too
                  close and would run into you if you braked hard.
                </li>
              </ul>
            </div>
          </div>
      ...
      <div className="mt-8">
        ...
        <div className="mt-3 flex items-center gap-4">
          ...
          <p className="text-sm text-muted-foreground">
            A green arrow shown with a red light means you may filter{" "}
            <strong>only in the direction of the arrow</strong>, even though the main light is red.
            Give way to any pedestrians crossing and other traffic already on the junction.
          </p>
        </div>
      </div>
      ...
      <div className="mt-8">
        ...
        <div className="mt-3 flex items-center gap-4">
          ...
          <p className="max-w-prose text-sm text-muted-foreground">
            A flashing amber light follows the red at a <strong>Pelican crossing</strong>. It means:{" "}
            <strong>give way to any pedestrians still on the crossing</strong>. If the crossing is
            clear you may proceed with caution — do not race the light.
          </p>
        </div>
      </div>
      ...
      <div className="mt-10">
        <div className="text-sm font-semibold">
          Pedestrian & cycle crossings — what the names mean
        </div>
        <div className="mt-4 grid gap-4 md:grid-cols-3">
          <div className="border border-border p-4">
            ...
            <p className="mt-2 text-sm">
              Push-button crossing with signals on the <em>far</em> side of the road. Sequence
              includes a <strong>flashing amber</strong> to drivers and a{" "}
              <strong>flashing green</strong> man to pedestrians — pedestrians already on the
              crossing have priority.
            </p>
          </div>
          ...
          <div className="border border-border p-4">
            ...
            <p className="mt-2 text-sm">
              Kerb-side signals with sensors that <strong>detect pedestrians</strong> and hold the
              red until they've finished crossing. <strong>No flashing amber</strong> phase — the
              sequence is the same as normal traffic lights.
            </p>
          </div>
          ...
          <div className="border border-border p-4">
            ...
            <p className="mt-2 text-sm">
              A wider crossing shared by <strong>pedestrians and cyclists</strong>, who may ride
              across. Kerb-side signals like a Puffin — <strong>no flashing amber</strong>.
            </p>
          </div>
        </div>

        <div className="mt-4 border border-border bg-secondary/40 p-3 text-xs text-muted-foreground">
          Also worth knowing: <strong>Zebra</strong> — black-and-white stripes with flashing yellow
          Belisha beacons, no signals; you must give way once anyone has stepped on.{" "}
          <strong>Pegasus (equestrian)</strong> — like a Toucan but with a higher control panel for
          horse riders.
        </div>
      </div>
    </Panel>
  ...
  return (
    <section className="border border-border bg-card p-5 sm:p-6">
      ...
      <h3 className="mt-1 font-display text-2xl leading-tight">
        MUST vs SHOULD — read the wording carefully
      </h3>
      <p className="mt-2 text-sm text-muted-foreground">
        The Highway Code uses two very different tones. Getting the difference right is what
        separates a competent learner driver from a nervous one.
      </p>
      <div className="mt-4 grid gap-3 md:grid-cols-2">
        <div className="border border-destructive/60 bg-destructive/5 p-4">
          ...
          <p className="mt-2 text-sm">
            A <strong>legal requirement</strong>. Breaking it is an offence — you can be fined, get
            penalty points, be disqualified or, in serious cases, prosecuted. Examples: stopping at
            a red light, wearing a seatbelt, not using a hand-held phone.
          </p>
        </div>
        <div className="border border-primary/50 bg-primary/5 p-4">
          ...
          <p className="mt-2 text-sm">
            <strong>Strong guidance</strong>, not a specific offence in itself — but ignoring it can
            still be used in court to establish liability (e.g. careless or dangerous driving).
            Examples: giving way to pedestrians waiting to cross at a junction (Rule H2), leaving a
            safe following distance (Rule 126).
          </p>
        </div>
      </div>
      <p className="mt-3 text-xs text-muted-foreground">
        Throughout this portal we try to use the same wording as the Highway Code. If you see{" "}
        <strong>MUST</strong> it is law; if you see
...
function HierarchyPyramid() {
  ...
  return (
    ...
    >
      ...
      <desc id={descId}>
        Pyramid diagram from Rule H1 of the UK Highway Code, ordered from the most vulnerable road
        users at the top to those with the greatest responsibility to reduce danger at the bottom.
        Top to bottom: 1. Pedestrians — children, older and disabled people have the highest
        priority. 2. Cyclists — including e-cycles. 3. Horse riders and horse-drawn vehicles. 4.
        Motorcyclists — mopeds and motorbikes. 5. Cars and taxis — private vehicles. 6. Vans and
        minibuses — light goods vehicles. 7. HGVs and large vehicles — greatest responsibility to
        reduce danger. Road users who can cause the greatest harm must take the greatest
      ...
      <g fontFamily="Arial, sans-serif" fontSize="12" fill="#0b1f1c">
        ...
        <text x="42" y={apexY + 22} fontWeight={700}>
          Highest priority
        </text>
        <text x="42" y={apexY + 38}>
          Most vulnerable
        </text>
        <text x="42" y={baseY - 24} fontWeight={700}>
      ...
      {/* Rule tags (right) */}
      <g fontFamily="Arial, sans-serif" fontSize="12" fill="#0b1f1c">
        <text x={W - 20} y={apexY + 22} textAnchor="end" fontWeight={700}>
          Rule H1
        </text>
        <text x={W - 20} y={apexY + 38} textAnchor="end">
          Hierarchy
        </text>
        <text x={W - 20} y={apexY + 74} textAnchor="end" fontWeight={700}>
          Rule H2
        </text>
        <text x={W - 20} y={apexY + 90} textAnchor="end">
          Priority for pedestrians
        </text>
        <text x={W - 20} y={apexY + 126} textAnchor="end" fontWeight={700}>
          Rule H3
        </text>
        <text x={W - 20} y={apexY + 142} textAnchor="end">
  ...
  return (
    ...
    >
      ...
      <g transform="translate(312 266) rotate(-58)">
        ...
        <path
          d="M34 -18 L46 -28 M37 -12 L53 -12 M34 -6 L46 4"
          stroke="#f59e0b"
          strokeWidth="2.5"
          strokeLinecap="round"
        />
      ...
      <g transform="translate(268 196)">
        ...
        {/* torso — jacket */}
        <path
          d="M-7.5,6 L7.5,6 L9.5,24 L-9.5,24 Z"
          fill="#1d4ed8"
          stroke="#0b1f1c"
          strokeWidth="0.8"
        />
    ...
    >
      <div className="grid gap-4 lg:grid-cols-[1.1fr_1fr]">
        <div>
          ...
          <p className="sr-only">
            Hierarchy of Road Users pyramid from Rule H1. Read from top to bottom, the pyramid
            shows: 1. Pedestrians — children, older and disabled people have the highest priority.
            2. Cyclists — including e-cycles. 3. Horse riders and horse-drawn vehicles. 4.
            Motorcyclists — mopeds and motorbikes. 5. Cars and taxis — private vehicles. 6. Vans and
            minibuses — light goods vehicles. 7. HGVs and large vehicles — these road users can
            cause the greatest harm and so have the greatest responsibility to reduce danger. The
            hierarchy does not remove the need for all road users to behave responsibly.
          </p>
        </div>
        ...
        <div className="grid gap-3 text-sm leading-relaxed text-foreground">
          <div className="border border-border bg-secondary/40 p-3">
            <div className="mb-1 text-xs font-semibold uppercase tracking-wide text-muted-foreground">
              Rule H1 — The hierarchy
            </div>
            Those who can do the greatest harm have the greatest responsibility to reduce the danger
            or threat they pose to others. It does <em>not</em>
          ...
          <div className="border border-border bg-secondary/40 p-3">
            ...
            At a junction you{" "}
            <strong>should give way to pedestrians crossing or waiting to cross</strong> a road into
            which or from which you are turning. Also give way on zebra crossings and to pedestrians
            and cyclists on parallel crossings.
          </div>
          <div className="border border-border bg-secondary/40 p-3">
            <div className="mb-1 text-xs font-semibold uppercase tracking-wide text-muted-foreground">
              Rule H3 — Priority for cyclists
            </div>
            Do not cut across cyclists, horse riders or horse-drawn vehicles going ahead when
            turning into or out of a junction, or when changing direction or lane — just as you
            would not turn across the path of another motor vehicle.
          </div>
        </div>
      </div>
      ...
      <div className="mt-6">
        <h4 className="mb-1 text-base font-semibold text-foreground">
          Worked example — turning from a major road into a minor road
        </h4>
        <p className="mb-3 text-sm text-muted-foreground">
          You are driving on the <strong>major road</strong> and turning into a
          <strong> minor road</strong> (the side road with the give-way line). A pedestrian is
          crossing — or waiting to cross — the mouth of that minor road.
        </p>
        ...
        <div className="mt-4 grid gap-3 md:grid-cols-2">
          <div className="border border-border bg-emerald-50 p-3 text-sm dark:bg-emerald-950/30">
            ...
            <strong> should give way</strong> under Rule H2 (guidance, not a legal MUST). Stop{" "}
            <em>before</em> the give-way line and let them finish crossing — do not wave them
            across.
          </div>
          <div className="border border-border bg-amber-50 p-3 text-sm dark:bg-amber-950/30">
            <div className="mb-1 text-xs font-semibold uppercase tracking-wide text-amber-800 dark:text-amber-300">
              You don't have to stop
            </div>
            If <strong>braking suddenly would create an immediate danger</strong>
            to you or other road users — for example a vehicle is right behind you — and the
            pedestrian <strong>has not begun crossing</strong>, continue <strong>cautiously</strong>
            . Defensive driving comes first; judgement, not blind rule-following.
          </div>
        </div>

        <ol className="mt-4 list-decimal space-y-1 pl-5 text-sm text-foreground">
          <li>
            <strong>Mirrors — Signal — Position — Speed — Look (MSPSL)</strong> on approach.
          </li>
          <li>
            Scan the pavement on both sides <em>before</em> you commit to the turn.
          </li>
          <li>
            If a pedestrian is crossing or waiting, and it is safe,{" "}
            <strong>stop and give way</strong>.
          </li>
          <li>
            If braking suddenly would create an immediate danger to you or others, and no one has
            started crossing, continue cautiously.
          </li>
          <li>Never wave pedestrians across — let them decide. Other drivers may not see them.</li>
        </ol>

        <GeorgesTip title="Turning at junctions">
          Before you commit to any turn, take a proper look at the pavement you're turning across —{" "}
          <strong>not just the road</strong>. On a busy high street I always slow more than feels
          necessary; the extra second buys you a decision if a pedestrian steps off.
        </GeorgesTip>
      </div>
    </Panel>
  );
...
function ZebraSceneSvg() {
  ...
  return (
    ...
    >
      ...
      <g>
        <path
          d="M 298 44 L 298 62 L 294 62 L 302 72 L 310 62 L 306 62 L 306 44 Z"
          fill="#ffd54a"
          stroke="#111"
          strokeWidth="0.6"
        />
      ...
      <g fontFamily="Arial, sans-serif" fill={PAINT} fontWeight="700" letterSpacing="0.4">
        ...
        <text x="14" y="358" fontSize="10">
          PAVEMENT
        </text>
        <text x="24" y="130" fontSize="9" opacity="0.9">
          ZIG-ZAGS · NO OVERTAKING · NO PARKING
        </text>
        <text x="24" y="262" fontSize="9" opacity="0.9">
          ZIG-ZAGS · NO OVERTAKING · NO PARKING
        </text>
      </g>
    </svg>
    ...
    >
      ...
      <div className="mt-5 grid gap-4 md:grid-cols-2">
        <div className="border border-border p-4">
          ...
          <p className="mt-2 text-sm">
            You <strong>must give way</strong> to anyone who has moved onto the crossing, and —
            since the 2022 Highway Code update — you{" "}
            <strong>should also give way to anyone waiting to cross</strong> (rule H2 &amp; rule
            195).
          </p>
          <ul className="mt-3 list-disc space-y-1.5 pl-5 text-sm text-muted-foreground">
            <li>Approach at a speed that lets you stop safely.</li>
            <li>
              <strong>Do not wave or signal</strong> pedestrians across — another driver may not
              have seen them.
            </li>
            <li>
              <strong>No overtaking</strong> or parking on the zig-zag lines.
            </li>
            <li>
              Be ready for pedestrians to run — treat cyclists on a parallel/tiger crossing the same
              way.
            </li>
          </ul>
        </div>
        ...
        <div className="border border-border p-4">
          <div className="text-[11px] font-semibold uppercase tracking-wider text-accent">
            Funnel vision — how to look
          </div>
          <p className="mt-2 text-sm">
            As you drive, your view naturally narrows to a <strong>funnel</strong> straight ahead.
            The Highway Code (rules 92, 97, 146, 204) tells drivers to actively counter this by{" "}
            <strong>scanning wider</strong> — kerb to kerb, mirror to mirror — so you spot
            pedestrians <em>before</em> they step off.
          </p>
          <ul className="mt-3 list-disc space-y-1.5 pl-5 text-sm text-muted-foreground">
            <li>
              <strong>Look far</strong> down the road for the flashing Belisha beacons — your first
              clue a zebra is ahead.
            </li>
            <li>
              <strong>Scan the pavements</strong> either side, not just the crossing itself.
            </li>
            <li>
              Watch for <strong>children, prams, wheelchair &amp; mobility users</strong> — they may
              be slower or partially hidden.
            </li>
            <li>
              <strong>Mirror &amp; cover the brake</strong> as you reach the zig-zags.
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="mt-4 border border-border bg-secondary/40 p-3 text-xs text-muted-foreground">
        Also worth knowing: on a <strong>parallel crossing</strong> (zebra with a cycle lane
        alongside), cyclists have the same priority as pedestrians. A <strong>staggered</strong>{" "}
        crossing with a central island counts as <strong>two separate crossings</strong>.
      </div>

      <GeorgesTip title="Zebra crossings">
        Don't just look at the crossing itself — scan <strong>both pavements</strong>
        before you arrive. A pedestrian walking briskly towards the kerb is already a developing
        hazard. If you're unsure, <strong>cover the brake early</strong>. Never wave people across —
        another driver may not have seen them.
      </GeorgesTip>
      ...
      <div className="mt-8">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          When a zebra has a <strong>central island</strong> in the middle of the road, it counts as{" "}
          <strong>two separate zebra crossings</strong> — one for each half of the carriageway.
        </p>

        <div className="mt-3">
          <ZoomPan
            aspect="640/380"
            label="Zebra crossing with central island — pinch or scroll to zoom"
          >
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          <div className="border border-border bg-secondary/40 p-3 text-sm leading-relaxed">
            <div className="mb-1 text-xs font-semibold uppercase tracking-wide text-muted-foreground">
              If the pedestrian is on the far side
            </div>
          ...
          <div className="border border-border bg-secondary/40 p-3 text-sm leading-relaxed">
            <div className="mb-1 text-xs font-semibold uppercase tracking-wide text-muted-foreground">
              If they'll reach your side before you do
            </div>
            If you judge that they'll be{" "}
            <strong>halfway across (on the island) before you reach the crossing</strong>, you{" "}
            <strong>must wait</strong>. It's <em>not a competition</em> — never race a pedestrian.
          </div>
        </div>

        <div className="mt-3 border border-border bg-secondary/40 p-3 text-xs text-muted-foreground">
          <strong>Funnel vision:</strong> as your speed rises your view narrows to a funnel straight
          ahead. Actively <strong>scan wider</strong> — kerb to kerb, both sides of the island — so
          you see anyone approaching either half of the crossing well before they step off.
        </div>
      </div>
    </Panel>
  );
  ...
  return (
    ...
    >
      ...
      <g fontFamily="Arial, sans-serif" fill={PAINT} fontWeight="700" letterSpacing="0.4">
        ...
        <text x="24" y="128" fontSize="9" opacity="0.9">
          CROSSING 1 — TOP HALF
        </text>
        <text x="24" y="262" fontSize="9" opacity="0.9">
          CROSSING 2 — BOTTOM HALF
        </text>
      </g>
...
function CrossroadsBase({ children }: { children?: ReactNode }) {
  return (
    ...
    >
      ...
      <g fill="#f8fafc">
        <rect x="250" y="252" width="70" height="6" />{" "}
        {/* south-bound stop (top of junction) — for vehicles from north */}
        <rect x="320" y="122" width="70" height="6" />{" "}
        {/* north-bound stop (bottom of junction, wait no) */}
  ...
  return (
    <CrossroadsBase>
      ...
      <g fontFamily="Arial, sans-serif" fontSize="11" fontWeight="700">
        ...
        <text x="24" y="32" fill="#dc2626">
          Red — turning RIGHT
        </text>
        <text x="24" y="48" fill="#0b1f1c" fontWeight="500">
          May wait in box if only oncoming blocks you
        </text>

        <rect x="410" y="14" width="216" height="48" fill="#ffffff" opacity="0.94" rx="3" />
        <text x="420" y="32" fill="#1d4ed8">
          Blue — STRAIGHT ahead
        </text>
        <text x="420" y="48" fill="#0b1f1c" fontWeight="500">
          Still far away — priority through the box
        </text>
      </g>
    </CrossroadsBase>
  );
...
function YellowBoxJunction() {
  return (
    ...
    >
      <ZoomPan
        aspect="640/380"
        label="Aerial view of a yellow box junction. A red car has entered the hatched yellow box, signalling right, and is waiting inside because a blue oncoming vehicle is blocking the exit road. A dashed yellow line shows the intended path to the right."
      >
      ...
      <div className="mt-5 grid gap-4 md:grid-cols-2">
        <div className="border border-border p-4">
          ...
          <p className="mt-2 text-sm">
            You <strong>must not enter the yellow box</strong> unless your{" "}
            <strong>exit road or lane is clear</strong>. If you stop inside and block the box,
            that's an offence.
          </p>
        </div>
        <div className="border border-border p-4">
          ...
          <p className="mt-2 text-sm">
            You <strong>may enter and wait inside the box</strong> when you want to{" "}
            <strong>turn right</strong> and the <em>only</em> thing stopping you is{" "}
            <strong>oncoming traffic</strong>, or vehicles already waiting to turn right ahead of
            you.
          </p>
        </div>
      </div>
      ...
      <div className="mt-4 border border-border bg-secondary/40 p-3 text-sm">
        ...
        <ul className="list-disc space-y-1.5 pl-5 text-sm">
          <li>
            <strong>Check the exit first.</strong> Look past the box to the road you're turning into
            — if it's queued up, stay behind the box until it clears.
          </li>
          <li>
            <strong>Signal right</strong>, move to the centre of the box, wheels straight (so a
            shunt from behind doesn't push you into oncoming).
          </li>
          <li>
            <strong>Wait for a safe gap</strong>, then complete the turn — don't take an "iffy" gap
            just because the lights are changing.
          </li>
          <li>
            If the lights change to red while you're inside the box,{" "}
            <strong>complete the turn</strong> when it's safe — you're committed.
          </li>
        </ul>
      </div>
    </Panel>
  ...
  return (
    <CrossroadsBase>
      ...
      <g fontFamily="Arial, sans-serif" fontSize="11">
        ...
        <text x="24" y="32" fill="#0b1f1c" fontWeight="700">
          Nearside — turn IN FRONT (left-to-left)
        </text>
        <text x="24" y="48" fill="#0b1f1c">
          Red 6→3, Blue 12→9. Passenger-side to passenger-side.
        </text>
      </g>
    </CrossroadsBase>
  );
  ...
  return (
    <CrossroadsBase>
      ...
      <g fontFamily="Arial, sans-serif" fontSize="11">
        <rect x="14" y="14" width="290" height="46" fill="#ffffff" opacity="0.94" rx="3" />
        <text x="24" y="32" fill="#0b1f1c" fontWeight="700">
          Offside — swing BEHIND (right-to-right)
        </text>
        <text x="24" y="48" fill="#0b1f1c">
          Red 6→3, Blue 12→9. Driver-side to driver-side.
        </text>
      </g>
    </CrossroadsBase>
  );
    ...
    >
      <div className="space-y-4">
        ...
        >
          <ZoomPan
            aspect="640/380"
            label="Aerial view of a nearside-to-nearside right turn. A red car from the bottom and a blue oncoming car from the top both turn right, crossing in front of each other so their passenger sides meet in the middle of the junction."
          >
            <NearsideTurnSvg />
          </ZoomPan>
        </figure>
        <figure role="group" aria-labelledby="offside-heading" aria-describedby="offside-explainer">
          <ZoomPan
            aspect="640/380"
            label="Aerial view of an offside-to-offside right turn. A red car from the bottom and a blue oncoming car from the top both turn right, swinging wide behind each other so their driver sides pass on the outside."
          >
            <OffsideTurnSvg />
          </ZoomPan>
        </figure>
      ...
      <div className="mt-5 grid gap-4 md:grid-cols-2" aria-live="polite">
        <div className="border border-border p-4" id="nearside-explainer">
          ...
          >
            Nearside to nearside (left-to-left)
          </div>
          <p className="mt-2 text-sm">
            <strong>Nearside = passenger side to passenger side.</strong> Both cars turn{" "}
            <strong>in front of</strong> each other, passing left-side to left-side. Rule 181 lists
            this as the second option.
          </p>
          <p className="mt-2 text-sm text-muted-foreground">
            Tighter, quicker turn — but the other car briefly blocks your view of oncoming traffic
            while you're crossing, so creep and look before committing.
          </p>
        </div>
        <div className="border border-border p-4" id="offside-explainer">
          <div
            ...
            className="text-[11px] font-semibold uppercase tracking-wider text-accent"
          >
            Offside to offside (right-to-right)
          </div>
          <p className="mt-2 text-sm">
            <strong>Offside = driver's side to driver's side.</strong> Keep the other vehicle on
            your right and turn <strong>behind</strong> it. Rule 181 calls this{" "}
            <em>generally the safer method</em> because you have a clear view of oncoming traffic as
            you complete the turn.
          </p>
          <p className="mt-2 text-sm text-muted-foreground">
            Wider swept path. Use this by default unless road markings or the layout of the junction
            force the nearside method.
          </p>
        </div>
      </div>
      ...
      <div className="mt-4 border border-border bg-secondary/40 p-3 text-sm">
        ...
        <ul className="list-disc space-y-1.5 pl-5 text-sm">
          <li>
            <strong>Follow the road markings first.</strong> If there is a painted guide arrow,
            dashed turning line or a raised island in the middle of the junction, use the path the
            markings show — that overrides your preference.
          </li>
          <li>
            <strong>If there are no markings</strong> (this diagram), you have to{" "}
            <strong>read the other driver</strong>. Watch their line, their wheels and their eyes as
            they enter the box — commit to whichever side they are giving you.
          </li>
          <li>
            <strong>Never assume.</strong> A firm, early <strong>right indicator</strong> plus
            gentle creep tells the other driver you're turning; make eye contact if you can.
          </li>
          <li>
            <strong>Big vehicles turn wide.</strong> Lorries, buses and vans almost always take the
            offside line — give them room and expect the swept path.
          </li>
        </ul>
      </div>
    </Panel>
...
function StaggeredBase({ children }: { children?: ReactNode }) {
  return (
    ...
    >
      ...
      <g fill="#f8fafc">
        {[10, 50, 90, 130].map((x) => (
          <rect key={`hw${x}`} x={x} y="188" width="20" height="4" />
        ))}
        {[490, 530, 570, 610].map((x) => (
          <rect key={`he${x}`} x={x} y="188" width="20" height="4" />
        ))}
        {[10, 30, 50, 70, 90].map((y) => (
          <rect key={`nv${y}`} x="218" y={y} width="4" height="14" />
        ))}
        {[280, 300, 320, 340, 360].map((y) => (
          <rect key={`sv${y}`} x="418" y={y} width="4" height="14" />
        ))}
      </g>
  ...
  return (
    <StaggeredBase>
      ...
      <g fontFamily="Arial, sans-serif" fontSize="11">
        ...
        <text x="24" y="32" fill="#0b1f1c" fontWeight="700">
          Staggered — OFFSIDE recommended
        </text>
        <text x="24" y="48" fill="#0b1f1c">
          Offset approaches force a wide swing behind each other.
        </text>
      </g>
    </StaggeredBase>
  );
  ...
  return (
    <StaggeredBase>
      ...
      <g fontFamily="Arial, sans-serif" fontSize="11">
        <rect x="14" y="14" width="300" height="46" fill="#ffffff" opacity="0.94" rx="3" />
        <text x="24" y="32" fill="#0b1f1c" fontWeight="700">
          Staggered — NEARSIDE risky
        </text>
        <text x="24" y="48" fill="#0b1f1c">
          Tight lines converge — high conflict at centre.
        </text>
      </g>
    </StaggeredBase>
  );
...
function MajorMinorBase({ children }: { children?: ReactNode }) {
  return (
    ...
    >
      ...
      <g fill="#f8fafc">
        {[10, 50, 90, 130, 170, 210].map((x) => (
          <rect key={`mw${x}`} x={x} y="188" width="20" height="4" />
        ))}
        {[420, 460, 500, 540, 580, 610].map((x) => (
          <rect key={`me${x}`} x={x} y="188" width="20" height="4" />
        ))}
        {/* Minor road centre line */}
        {[10, 30, 50].map((y) => (
          <rect key={`mnn${y}`} x="318" y={y} width="4" height="14" />
        ))}
        {[320, 340, 360].map((y) => (
          <rect key={`mns${y}`} x="318" y={y} width="4" height="14" />
        ))}
      </g>
  ...
  return (
    <MajorMinorBase>
      ...
      <g fontFamily="Arial, sans-serif" fontSize="11">
        ...
        <text x="24" y="32" fill="#0b1f1c" fontWeight="700">
          Major/minor — NEARSIDE
        </text>
        <text x="24" y="48" fill="#0b1f1c">
          Both wait at give-way, then cut in front — quick but blind.
        </text>
      </g>
    </MajorMinorBase>
  );
  ...
  return (
    <MajorMinorBase>
      ...
      <g fontFamily="Arial, sans-serif" fontSize="11">
        <rect x="14" y="14" width="310" height="46" fill="#ffffff" opacity="0.94" rx="3" />
        <text x="24" y="32" fill="#0b1f1c" fontWeight="700">
          Major/minor — OFFSIDE (preferred)
        </text>
        <text x="24" y="48" fill="#0b1f1c">
          Wider path but each driver sees oncoming traffic clearly.
        </text>
      </g>
    </MajorMinorBase>
  );
  ...
  return (
    ...
    >
      ...
      <div className="mb-2 text-[11px] font-semibold uppercase tracking-wider text-accent">
        Scenario A · Staggered crossroads (offset approaches)
      </div>
      <p className="mb-3 text-sm text-muted-foreground">
        The south arm is offset east of the north arm. Two right-turners meet with their approaches
        out of line — the nearside path forces them nose-to-nose, so the offside sweep is the only
        comfortable option.
      </p>
      <div className="grid gap-3 md:grid-cols-2">
        <figure
          role="group"
          aria-label="Staggered crossroads, offside method: red from south-east arm and blue from north-west arm both turn right and swing wide behind each other, ending in their exit road's left lane."
        >
        ...
        <figure
          role="group"
          aria-label="Staggered crossroads, nearside method: the tight turn lines converge in the middle of the junction, creating a nose-to-nose conflict marked with a red X."
        >
      ...
      <div className="mt-3 border border-border p-4 text-sm">
        <strong>Outcome:</strong> pick <strong>offside</strong>. The offset means a nearside line
        would put you nose-to-nose with the other driver in the middle of the box. Drive on until
        you're level with the other car's offside, then turn.
      </div>

      {/* Scenario B: major / minor */}
      <div className="mt-6 mb-2 text-[11px] font-semibold uppercase tracking-wider text-accent">
        Scenario B · Major road meeting minor road (give-way both sides)
      </div>
      <p className="mb-3 text-sm text-muted-foreground">
        Both turners are emerging from a narrow minor road onto a wider major road, so both must
        give way to major-road traffic first. Once clear, the method still matters — nearside is
        fast but blind, offside gives a clear view of any late oncoming vehicle.
      </p>
      <div className="grid gap-3 md:grid-cols-2">
        <figure
          role="group"
          aria-label="Major/minor crossroads, nearside method: after giving way, red and blue turn in front of each other, taking the short tight line."
        >
        ...
        <figure
          role="group"
          aria-label="Major/minor crossroads, offside method: after giving way, red and blue swing wide behind each other, keeping oncoming traffic in view."
        >
      ...
      <div className="mt-3 border border-border p-4 text-sm">
        <strong>Outcome:</strong> <strong>offside</strong> is safer here too. Because you have to
        accelerate to clear the major road, you need the clearest possible view of anything
        approaching along it — the nearside line puts the other right-turner directly in your
        sight-line.
      </div>
      ...
      <div className="mt-5 border border-border bg-secondary/40 p-3 text-sm">
        ...
        <ul className="list-disc space-y-1.5 pl-5 text-sm">
          <li>
            <strong>Symmetrical box, no markings</strong> → either method works; agree with the
            other driver.
          </li>
          <li>
            <strong>Staggered / offset approaches</strong> → offside (swing wide behind).
          </li>
          <li>
            <strong>Painted turn arrows or an island</strong> → follow the paint; usually nearside.
          </li>
          <li>
            <strong>Minor onto major</strong> → offside — you need the sightline for the give-way.
          </li>
          <li>
            <strong>Whatever you choose</strong> → both cars finish in their exit road's LEFT lane.
            Always.
          </li>
        </ul>
      </div>
  ...
  return (
    <g fontFamily="Arial, sans-serif" fontSize="14" fontWeight="800" fill="#f8fafc">
      {[
        ...
        <text key={l.n} x={l.x} y={406} textAnchor="middle">
          Lane {l.n}
        </text>
      ))}
    </g>
  ...
  return (
    ...
    >
      <div className="grid gap-5">
        <figure
          role="group"
          aria-label="Smart motorway gantry showing lane 1 closed with a red X, and 60 mph variable speed limit signs above the remaining three lanes. A car is merging out of the closed lane into lane 2."
        >
          <div className="mb-2 text-[11px] font-semibold uppercase tracking-wider text-accent">
            Diagram 1 · Lane closed + reduced speed
          </div>
          <ZoomPan
            aspect="640/420"
            label="Smart motorway — lane 1 closed by a red X and a 60 mph limit applied to all remaining lanes."
          >
            <SmartMotorwayClosureSvg />
          </ZoomPan>
          <p className="mt-3 text-sm">
            The <strong>red X</strong> above lane 1 means <strong>that lane is closed</strong> — you
            must not drive, stop or overtake in it. The <strong>60 mph in a red ring</strong> above
            every other lane is a <strong>mandatory speed limit</strong> that{" "}
            <strong>applies from this gantry onwards</strong> across the whole carriageway.
          </p>
        </figure>

        <figure
          role="group"
          aria-label="Smart motorway gantry showing the national speed limit sign (white circle with a diagonal white bar) above all four lanes, meaning the previous restriction has ended."
        >
          <div className="mb-2 text-[11px] font-semibold uppercase tracking-wider text-accent">
            Diagram 2 · National speed limit resumes
          </div>
          <ZoomPan
            aspect="640/420"
            label="Smart motorway — national speed limit signs above every lane, cancelling the previous 60 mph restriction."
          >
            <SmartMotorwayEndSvg />
          </ZoomPan>
          <p className="mt-3 text-sm">
            The <strong>national speed limit</strong> pictogram (white circle with a diagonal white
            bar) <strong>cancels the previous variable limit</strong>. From this gantry onwards you
            are back to the motorway's national limit — <strong>70 mph</strong> for cars and light
            vans. Lane 1 is open again.
          </p>
        </figure>
      </div>
      ...
      <div className="mt-5 grid gap-4 md:grid-cols-2">
        <div className="border border-border p-4">
          ...
          <ul className="mt-2 list-disc space-y-1.5 pl-5 text-sm">
            <li>
              <strong>Do not drive</strong> in a lane closed by a red X — even if it looks empty.
            </li>
            <li>
              Move out <strong>early</strong> and steadily; don't cut across at the last moment.
            </li>
            <li>
              The closure lasts <strong>until the next gantry</strong> shows a blank sign or "End"
              symbol.
            </li>
          </ul>
        </div>
        <div className="border border-border p-4">
          ...
          <ul className="mt-2 list-disc space-y-1.5 pl-5 text-sm">
            <li>
              Numbers in a <strong>red ring</strong> on a gantry are <strong>mandatory</strong>, not
              advisory.
            </li>
            <li>
              They <strong>apply from this gantry onwards</strong>, across every lane below the
              sign.
            </li>
            <li>
              Only the <strong>national speed limit pictogram</strong> — or a blank gantry — cancels
              them.
            </li>
          </ul>
        </div>
