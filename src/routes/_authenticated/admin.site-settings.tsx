      ...
      <div className="grid gap-6">
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div>
                <Label>Phone (WhatsApp intl, no +)</Label>
                <Input
                  className="mt-1"
                  value={business.phone_intl ?? ""}
                  onChange={(e) => setBusiness({ ...business, phone_intl: e.target.value })}
                />
              </div>
              <div>
                <Label>Email</Label>
            ...
            <Button onClick={() => save("business", business)} disabled={saving === "business"}>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            >
              <Save className="mr-2 h-4 w-4" />
              {saving === "opening_hours" ? "Saving…" : "Save hours"}
            </Button>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <Button onClick={() => save("social", social)} disabled={saving === "social"}>
              <Save className="mr-2 h-4 w-4" />
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div>
              <Label>Footer copy line</Label>
              <Textarea
                className="mt-1"
                value={footer.copy ?? ""}
                onChange={(e) => setFooter({ ...footer, copy: e.target.value })}
              />
            </div>
            <div>
            ...
            <Button onClick={() => save("footer", footer)} disabled={saving === "footer"}>
              <Save className="mr-2 h-4 w-4" />
