  ...
  head: () => ({
    meta: [
      { title: "About Us | GSM Driving School" },
      {
        name: "description",
        content:
          "GSM Driving School has been helping learners pass their driving tests for over 15 years with safety-first tuition.",
      },
      {
        property: "og:title",
      ...
      },
      {
        ...
        content: "Over 15 years of safety-first driving tuition.",
      },
    ],
  }),
  component: AboutPage,
      ...
      <section className="bg-secondary/40 py-16">
        <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            Over 15 years of helping learners become safe, confident drivers.
          </p>
        </div>
      </section>
