...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "DVSA-approved manual and automatic driving lessons in Notting Hill, Holland Park, Kensington and West London. Rated 5.0 from 143 five-star Google reviews." },
      { name: "author", content: "GSM Driving School" },
      { property: "og:title", content: "GSM Driving School — West London Driving Lessons" },
      { property: "og:description", content: "DVSA-approved manual and automatic driving lessons in Notting Hill, Holland Park, Kensington and West London. Rated 5.0 from 143 five-star Google reviews." },
