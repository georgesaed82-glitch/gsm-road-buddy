...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Driving Lessons Notting Hill, Kensington & West London | GSM Driving School" },
      { name: "description", content: "Driving lessons in Notting Hill, Kensington, Holland Park & West London. DVSA-approved local instructor, manual & automatic. Rated 5.0 from 143 Google reviews." },
      { name: "author", content: "GSM Driving School" },
      { property: "og:title", content: "Driving Lessons Notting Hill, Kensington & West London | GSM Driving School" },
      { property: "og:description", content: "Driving lessons in Notting Hill, Kensington, Holland Park & West London. DVSA-approved local instructor, manual & automatic. Rated 5.0 from 143 Google reviews." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "GSM Driving School" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Driving Lessons Notting Hill, Kensington & West London | GSM Driving School" },
