...
export const parallelParking: Lesson = {
  ...
  why: (
    <>
      ...
      <p>
        Any time you park behind another vehicle on the kerb — and on your practical driving test if
        the examiner asks for it. Parallel parking is one of the four set manoeuvres in the current
        DVSA test.
      </p>
      <p className="font-semibold uppercase tracking-wider text-accent text-xs">
        Why the 45° point matters
      </p>
      <p>
        Every parallel park is the same shape: an S-curve. The 45° point is the exact halfway moment
        of that S. If you turn full lock right too early, the nose swings wide into the road; too
        late, and the tail hits the kerb. Using the reversing camera guideline as George teaches
        removes the guesswork — you park by reference, not by feel.
      </p>
  ...
  mistakes: [
    {
      ...
      right:
        "Reverse with left lock first. Wait for the yellow camera line to touch the kerb — that's 45°. Only then, full lock right.",
    },
    {
    ...
    },
    {
      ...
      right:
        "Camera for the reference point, mirrors and shoulder checks for safety. Alternate constantly.",
    },
  ],
  gsmTips: [
  ...
  captions: [
    {
      at: 0.0,
      label: "Positioning",
      detail: "Pull alongside the parked car with a two-door gap. Indicate left.",
    },
    {
      at: 0.12,
      label: "Full 360° observation",
      detail: "Mirrors, over both shoulders, blind spots. Then select reverse.",
    },
    {
      at: 0.24,
      label: "Reverse with left lock",
      detail: "Clutch just biting, brake covering. Watch the yellow guideline on the camera.",
    },
    {
      at: 0.42,
      label: "45° reference point",
      detail:
        "Yellow guideline touches the kerb — this is George's cue. Steering wheel goes full lock RIGHT.",
    },
    {
      at: 0.6,
      label: "Straighten & keep reversing",
      detail: "Wheels straight, keep the same slow reverse speed, keep observing.",
    },
    {
      at: 0.88,
      label: "Final adjustment",
      detail: "Small right-lock swing tucks the nose in — straighten within 30 cm of the kerb.",
    },
  ],
  questions: [
    {
      ...
      options: [
        {
          ...
          explain:
            "Too late — the back of the car will hit the kerb because you're already at 45°.",
        },
        {
          label: "Full lock RIGHT while still slowly reversing",
          correct: true,
          explain:
            "Exactly right. Guideline on the kerb = 45° pivot moment. Steering wheel full right, keep the slow reverse going, and the car tucks itself in.",
        },
        {
          label: "Straighten the wheels and stop",
          explain:
            "The car is only halfway through the S-curve — stopping now leaves you sticking out into the road.",
        },
      ],
    },
    {
      at: 0.88,
      prompt:
        "You're now nearly parallel to the kerb. What's the last thing to do before applying the handbrake?",
      options: [
        {
          label: "Straighten the front wheels",
          correct: true,
          explain:
            "Correct. Straight wheels means you'll pull away smoothly and your tyres won't scrub — the mark of a professional finish.",
        },
        {
