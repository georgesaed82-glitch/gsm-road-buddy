...
export const signs: Sign[] = [
  ...
  { id: "w-hump", name: "Opening or swing bridge ahead", meaning: "The bridge ahead may open or swing to let boats through. Be prepared to stop at the signals or barriers — do not cross until the bridge is closed and the signals allow.", category: "warning", variant: { kind: "warning", symbol: "hump" } },
  ...
  { id: "w-lowbridge", name: "Overhanging building or structure ahead", meaning: "An overhanging building or structure crosses part of the road ahead. The available headroom is shown on the sign; drivers of high vehicles MUST check they can pass safely underneath.", category: "warning", variant: { kind: "warning", symbol: "low-bridge" } },
