...
export const sampleTheoryQuestions: TheoryQuestion[] = [
  ...
  // Rules of the road
  { id: "rules-of-the-road-1", category: "rules-of-the-road", question: "The national speed limit on a single carriageway for a car is…", options: ["50mph", "60mph", "70mph", "80mph"], correctIndex: 1, explanation: "60mph on single carriageway, 70mph on dual & motorway.", optionExplanations: ["50mph applies to certain vehicles like vans, not cars.", "Right — 60mph for cars on a single carriageway.", "70mph is for dual carriageways and motorways.", "80mph isn't a UK national limit."] },
  ...
  { id: "road-conditions-1", category: "road-conditions", question: "A red circle road sign generally means…", options: ["A warning", "Information", "A prohibition or order", "A motorway sign"], correctIndex: 2, explanation: "Circles give orders. Red circle = prohibition; blue circle = mandatory.", optionExplanations: ["Warnings are triangular, not circular.", "Information signs are rectangular.", "Right — red circles prohibit; blue circles instruct.", "Motorway signs are blue rectangles."] },
  { id: "road-conditions-2", category: "road-conditions", question: "A triangular sign with a red border is…", options: ["Information", "A warning", "A prohibition", "A direction sign"], correctIndex: 1, explanation: "Triangles warn you of a hazard ahead.", optionExplanations: ["Information signs are rectangular.", "Right — triangles always warn of an upcoming hazard.", "Prohibitions are circular with a red ring.", "Direction signs are rectangular and colour-coded by road type."] },
  ...
  { id: "other-types-of-vehicle-1", category: "other-types-of-vehicle", question: "Large lorries turning left at a junction often…", options: ["Turn from the left lane only", "Swing out to the right first to make the turn", "Ignore lane markings", "Reverse into the junction"], correctIndex: 1, explanation: "Long vehicles need to swing right before turning left. Never pass on their left.", optionExplanations: ["They can't — their length won't fit that arc.", "Right — expect them to move right first; keep well back.", "They follow the same rules; the arc just needs more space.", "They don't reverse into live junctions."] },
  { id: "motorway-rules-1", category: "motorway-rules", question: "On a three-lane motorway, the right-hand lane is for…", options: ["Lorries only", "Overtaking, then returning to the left", "Continuous driving at 70mph", "Vehicles towing trailers"], correctIndex: 1, explanation: "The right-hand lane is for overtaking. Return left when clear.", optionExplanations: ["Lorries are not allowed in lane three of a three-lane motorway.", "Right — overtake, then move back to the left.", "Lane hogging in lane three is an offence.", "Vehicles towing must not use lane three of a three-lane motorway."] },
];
